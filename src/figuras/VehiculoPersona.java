...
public class VehiculoPersona extends Figura {
    Vector3d direccion =new Vector3d(0,0,10);
    public String rutaCarpetaProyecto = System.getProperty("user.dir") + "/Texturas/";

  public VehiculoPersona(SimpleUniverse universo, BranchGroup conjunto, ArrayList<Figura> listaObjetos, Juego juego, boolean esPe, BoundingSphere limites){
      super(conjunto,  listaObjetos, juego, true);
      esMDL=true;
      esPersonaje = esPe;
      this.sonido = new ArrayList<BackgroundSound>();
     ...
     TransformGroup figuraVisual = crearObjetoMDL(universo, limites);
    ...
    TransformGroup crearObjetoMDL(SimpleUniverse universo, BoundingSphere limites) {
        ...
        apariencia.setColoringAttributes(colorRojo);

        Appearance aparienciaRueda = new Appearance();
        ColoringAttributes colorNegro = new ColoringAttributes(0.20f, 0.20f, 0.2f, ColoringAttributes.FASTEST);
        ...
        /*Appearance aparienciaPoli = new Appearance();
         Texture tex;
         tex = new TextureLoader(rutaCarpetaProyecto + "poli.jpg", juego).getTexture();
         aparienciaPoli.setTexture(tex);
         TextureAttributes texAttr = new TextureAttributes();
         texAttr.setTextureMode(TextureAttributes.MODULATE);
         aparienciaPoli.setTextureAttributes(texAttr);*/
        //Iluminación:
        ...
        Box techo = new Box(0.3f, 0.11f, 0.4f, apariencia);
        ...
        transladaD1.set(new Vector3f(-0.25f, 0, 0.51f));//-0.25f,0,0.51f
        ...
        transladaD2.set(new Vector3f(0.25f, 0, 0.51f));//0.25f,0,0.51f
        ...
        String ficheroSonido = "file:///"+System.getProperty("user.dir")+"//sonidos/heavyv8.WAV";
        anadirSonidoARama(objRoot, ficheroSonido, limites, 0);

        ficheroSonido = "file:///"+System.getProperty("user.dir")+"//sonidos/frenada.WAV";
        anadirSonidoARama(objRoot, ficheroSonido, limites, 1);
        
        ficheroSonido = "file:///"+System.getProperty("user.dir")+"//sonidos/policia.WAV";
        anadirSonidoARama(objRoot, ficheroSonido, limites, 2);
