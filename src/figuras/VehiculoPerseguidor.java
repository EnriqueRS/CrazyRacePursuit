...
public class VehiculoPerseguidor extends Figura {
   ...
   public VehiculoPerseguidor(BranchGroup conjunto,  ArrayList<Figura> listaObjetos, Juego juego, boolean esPe, int color){
...
TransformGroup crearObjetoMDL() {
        ...
        ColoringAttributes colorCoche=new ColoringAttributes();
        if(color==0)
            colorCoche = new ColoringAttributes(0.00f, 0.50f, 1.0f, ColoringAttributes.FASTEST);
        else if(color==1)
            colorCoche = new ColoringAttributes(0.20f, 1.00f, 0.0f, ColoringAttributes.FASTEST);
        else if(color==2)
            colorCoche = new ColoringAttributes(0.50f, 0.50f, 1.0f, ColoringAttributes.FASTEST);
